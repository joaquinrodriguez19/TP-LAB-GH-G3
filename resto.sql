...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2024 a las 03:16:01
...
CREATE TABLE `reservas` (
  ...
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
  `estado` enum('vigente','anulada') NOT NULL,
  `id_mesa` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `detallepedidos`
  ADD CONSTRAINT `detallepedidos_ibfk_1` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id`),
  ADD CONSTRAINT `detallepedidos_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`);
...
ALTER TABLE `pedidos`
  ...
  ADD CONSTRAINT `pedidos_ibfk_2` FOREIGN KEY (`id_mesero`) REFERENCES `meseros` (`id`);
